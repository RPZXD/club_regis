    ...
    <div class="bg-white rounded-lg shadow-lg w-full max-w-md">
        ...
        <div class="p-4">
            <form id="edit-club-form">
                ...
                <div class="mb-3">
                    <label class="block font-medium mb-1">ชื่อชุมนุม</label>
                    <input type="text" class="border rounded w-full px-2 py-1 focus:outline-none focus:ring-2 focus:ring-blue-400" name="club_name" id="edit_club_name" required>
                </div>
                <div class="mb-3">
                    <label class="block font-medium mb-1">รายละเอียด</label>
                    <textarea class="border rounded w-full px-2 py-1 focus:outline-none focus:ring-2 focus:ring-blue-400" rows="4" name="description" id="edit_description" required></textarea>
                </div>
                <div class="mb-3">
                    <label class="block font-medium mb-1">ระดับชั้นที่เปิด</label>
                    <div id="edit-grade-levels-checkboxes" class="flex flex-wrap gap-3">
                        <label class="inline-flex items-center space-x-2">
                            <input type="checkbox" name="grade_levels[]" value="ม.1" class="form-checkbox h-5 w-5 text-blue-600 rounded border-gray-300 focus:ring-blue-500 edit-grade-level">
                            <span class="text-gray-700">ม.1</span>
                        </label>
                        <label class="inline-flex items-center space-x-2">
                            <input type="checkbox" name="grade_levels[]" value="ม.2" class="form-checkbox h-5 w-5 text-blue-600 rounded border-gray-300 focus:ring-blue-500 edit-grade-level">
                            <span class="text-gray-700">ม.2</span>
                        </label>
                        <label class="inline-flex items-center space-x-2">
                            <input type="checkbox" name="grade_levels[]" value="ม.3" class="form-checkbox h-5 w-5 text-blue-600 rounded border-gray-300 focus:ring-blue-500 edit-grade-level">
                            <span class="text-gray-700">ม.3</span>
                        </label>
                        <label class="inline-flex items-center space-x-2">
                            <input type="checkbox" name="grade_levels[]" value="ม.4" class="form-checkbox h-5 w-5 text-blue-600 rounded border-gray-300 focus:ring-blue-500 edit-grade-level">
                            <span class="text-gray-700">ม.4</span>
                        </label>
                        <label class="inline-flex items-center space-x-2">
                            <input type="checkbox" name="grade_levels[]" value="ม.5" class="form-checkbox h-5 w-5 text-blue-600 rounded border-gray-300 focus:ring-blue-500 edit-grade-level">
                            <span class="text-gray-700">ม.5</span>
                        </label>
                        <label class="inline-flex items-center space-x-2">
                            <input type="checkbox" name="grade_levels[]" value="ม.6" class="form-checkbox h-5 w-5 text-blue-600 rounded border-gray-300 focus:ring-blue-500 edit-grade-level">
                            <span class="text-gray-700">ม.6</span>
                        </label>
                    </div>
                </div>
                <div class="mb-3">
                    <label class="block font-medium mb-1">จำนวนที่รับสมัคร</label>
                    <input type="number" class="border rounded w-full px-2 py-1 focus:outline-none focus:ring-2 focus:ring-blue-400" name="max_members" id="edit_max_members" required>
                </div>
                <div class="flex justify-end">
