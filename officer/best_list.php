    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            <div class="container-fluid">
                ...
                <!-- Members Modal -->
                <div id="members-modal" class="hidden fixed inset-0 bg-transparent flex items-center justify-center p-4">
                    <div class="bg-white rounded shadow-xl max-w-3xl w-full p-4">
